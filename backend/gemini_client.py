                            ...
                            turns=types.Content(
                                ...
                                parts=[
                                    ...
                                    types.Part(
                                        text=message.get(
                                            "text",
                                            "Continue the current conversation naturally and inspect this uploaded tax document. If it is a W-2, focus on the key visible values and do not guess any unclear field.",
                                        )
                                    ),
                                ],
                            ),
